...
if __name__ == "__main__":
    ...
    for scenario in scenarios:
        for lap in laps:
            # LOAD DATA
            path = f'/home/{username}/ssl-navigation-dataset/data/{scenario}'
            ...
            for frame_nr in data.frames:    
                ...
                print(f'Scenario: {scenario}_{lap} | Nr Particles: {robot_tracker.n_particles} | Current processing time: {dt:.3f} | Avg FPS: {avg_fps:.3f} | Frame nr: {frame_nr}')
